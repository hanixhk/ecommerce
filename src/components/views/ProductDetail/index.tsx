...
const ProductDetail:FC<{item:oneProductType}> = ({item}) => {
  ...
  return (
    ...
    (
        ...
        <div className="w-24" onClick={() => setImageForPreviewOfSelected(subItem._key)}>
            <Image width={1000} height={1000} src={urlFor(subItem).width(1000).height(1000).url()} alt={subItem.alt}  />
        </div>
    )
    )}
...
{/*right*/}
      ...
      <div className="p-6 space-y-8" >
          <div>
            ...
            <p className="text-gray-900-600 text-xl font-medium">{item.productTypes[0]}</p>
          </div>
